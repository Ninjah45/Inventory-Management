...
namespace InventoryTest
{
    ...
    {
        StockItemsDb stockDB = new StockItemsDb();
        ...
        {
            var stockTest = stockDB.GetItem(3);
        ...
        public void test_that_REMOVEITEM_deletes_from_list()
        {
            // Arrange
            int length = repo.GetAll().Count();
            var stockTest = stockDB.GetItem(1);

            // Act
            stockDB.RemoveItem(stockTest);
        ...
        {
            var customers = stockDB.ListItems();
